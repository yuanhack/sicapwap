...
LDFLAGS = -lssl -lcrypto -lpthread -ldl -D_REENTRANT -lsqlite3
...
# AC using 64-bit mysql
LDFLAGS += -Wl,-rpath,/usr/lib64/mysql -L/usr/lib64/mysql -lmysqlclient

CFLAGS += -Wall -g -O0 -D_REENTRANT
CFLAGS += -DCW_NO_DTLS -DCW_NO_DTLSCWParseConfigurationUpdateRequest
CFLAGS += -DSINOIX_PAYLOAD
